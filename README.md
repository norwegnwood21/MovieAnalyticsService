...
Ниже приведены основные экраны работы приложения, а также документация Swagger UI и результаты выполнения тестов.

---

**Рис. 1. Форма регистрации и входа**  
![Регистрация и вход](Screenshots/screen1.png)

**Рис. 2. Ввод списка фильмов**  
![Ввод фильмов](Screenshots/screen2.png)
